...
<div class="wrapper">
    <h1>Silver Spoon's Fine Dining</h1>
    ...
    <form method="POST" action="success_create_staff_Account.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" placeholder="silverspoons@dining.com" class="form-control <?php echo !$emailErr ?: 'is-invalid'; ?>" id="email" required value="<?php echo $email; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone_number" placeholder="+91 91087 91103" class="form-control <?php echo !$phone_numberErr ?: 'is-invalid'; ?>" id="phone_number" required value="<?php echo $phone_number; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="password" name="password" placeholder="silverspoons123@" id="password" required class="form-control <?php echo !$password_err ?: 'is-invalid' ; ?>" value="<?php echo $password; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
