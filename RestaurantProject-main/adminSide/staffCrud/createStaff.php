...
<div class="wrapper">
    ...
    <form method="POST" action="succ_create_staff.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="staff_name" placeholder="Enter staff full name" id="staff_name" required class="form-control <?php echo (!empty($staff_name_err)) ? 'is-invalid' : ''; ?>"><br>
        ...
        <div class="form-group">
            ...
            <input type="password" name="password" placeholder="Enter a strong password" id="password" required class="form-control <?php echo !$password_err ?: 'is-invalid' ; ?>" value="<?php echo $password; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
