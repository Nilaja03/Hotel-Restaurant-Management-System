<?php
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            $data.="
                <tr class='align-middle'>
                    ...
                    <td>$row[quantity] rooms</td>
                    <td>$status</td>
                    <td>
                        <button type='button' onclick='edit_details($row[id])' class='btn shadow-none btn-sm' style='background-color:#e6be8a' data-bs-toggle='modal' data-bs-target='#edit-room'>
                            <i class='bi bi-pencil-square' style='background-color:#e6be8a'></i>
                        </button>
                        <button type='button' onclick=\"room_images($row[id],'$row[name]')\" class='btn shadow-none btn-sm' style='background-color:#e6be8a' data-bs-toggle='modal' data-bs-target='#room-images'>
                            <i class='bi bi-images' style='background-color:#e6be8a'></i> 
                        </button>
    ...
    if(isset($_POST['get_room_images']))
    {
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            ...
            {
                $thumb_btn = "
                    <button onclick='thumb_image($row[sr_no],$row[room_id])' class='btn btn-secondary text-dark shadow-none'>
